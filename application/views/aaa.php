...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body style="background: #7BA9DE">  
	...
	<img src="http://localhost/UAS-WebRe-Perpus/aset/1.png" style="width: 70px; height: 70px; display: inline; margin: -5px 0 50px 0">
	<h3 style="margin: -120px 0 20px 90px; font-family: Georgia; font-size: 25px"><?=$q_instansi->nama?></h3> <br>
	<small style="font-family: Times New Roman; font-size: 17px; margin: -40px 0 0 90px; display: inline; position: absolute">Alamat : Mbarek, Jl. Kaliurang KM 4,5 N0.6 Gang Sumilir, Yogyakarta 552844 | (0274) 7440115</small>
	...
	<div class="row-fluid">
     ...
     <footer>
		<div><center>&reg; Copyright 2017 : Desi Rima Melany</div>
	</footer>
