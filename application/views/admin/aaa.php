  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" style="background: #CBD9BC">
      	<div style="margin-left: 20px">
			<img style="width: 70px; height: 70px; display: inline; float: left; margin-right: 20px" src="http://localhost/UAS-WebRe-Perpus/aset/1.png">
			<h3><?=$q_instansi->nama?></h3>
			<h6 style="font-family: Georgia; margin-top: -10px">Alamat : Mbarek, Jl. Kaliurang KM 4,5 N0.6 Gang Sumilir, Yogyakarta 552844 | (0274) 7440115</h6>
		</div>
